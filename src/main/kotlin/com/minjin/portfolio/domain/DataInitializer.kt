package com.minjin.portfolio.domain

import com.minjin.portfolio.domain.constant.SkillType
import com.minjin.portfolio.domain.entity.*
import com.minjin.portfolio.domain.repository.*
...
@Component
@Profile(value = ["default"]) // profile이 default일때만 작동
